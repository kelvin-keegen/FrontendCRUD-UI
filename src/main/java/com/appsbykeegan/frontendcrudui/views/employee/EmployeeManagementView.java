...
@Uses(Icon.class)
@Slf4j
public class EmployeeManagementView extends Div {
    ...
    public EmployeeManagementView(EmployeeRestfulService employeeRestfulService) {
        ...
        find.addClickListener(buttonClickEvent -> {
                ...
                if (body == null) {
                    ...
                    Notification error = Notification.show("Could not find Employee");
